...
export default function AboutSection() {
  const paragraphs = [
    ...
    "<strong class='text-[var(--text)] text-xl'>🎯 Mission</strong><br />Pulloju Ajith believes in leveraging technology and discipline to create a positive impact. His mission is to build innovative digital products, solve complex problems with AI, and inspire others to pursue continuous growth in their professional lives."
  ];
