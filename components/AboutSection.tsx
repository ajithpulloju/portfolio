...
export default function AboutSection() {
  const paragraphs = [
    "<strong class='text-[var(--text)] text-xl'>💻 Professional Profile</strong><br />Pulloju Ajith is a Full Stack Developer specializing in designing and developing modern, scalable web applications. He works with technologies including React.js, JavaScript, Node.js, Express.js, MongoDB, Supabase, SQL, HTML, CSS, Tailwind CSS, and Artificial Intelligence.<br /><br />His notable projects include Protein Pagal, a high-protein food ordering platform, an AI Diet Planner, and other web applications focused on solving real-world problems. He is passionate about creating fast, responsive, and user-friendly digital experiences. You can explore his code and projects on his <a href='https://github.com/ajithpulloju' target='_blank' rel='noopener noreferrer' class='text-[var(--accent-blue)] underline font-bold'>GitHub Profile</a>.",
    "<strong class='text-[var(--text)] text-xl'>💪 Fitness & Health Coaching</strong><br />Alongside his career in technology, Pulloju Ajith is a dedicated fitness coach and bodybuilder. He provides personalized guidance for Muscle building, Strength training, Fat loss, Body transformation, Nutrition planning, and Customized diet plans. His goal is to help individuals achieve sustainable fitness through science-based training, proper nutrition, and consistent lifestyle habits. Follow his fitness journey and tips on his <a href='https://www.instagram.com/chaotix_sthetix?igsh=MWppaDBtb3V4d2pkag%3D%3D&utm_source=qr' target='_blank' rel='noopener noreferrer' class='text-[var(--accent-orange)] underline font-bold'>Instagram (@chaotix_sthetix)</a>.",
